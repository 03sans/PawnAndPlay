 ...
 */
package com.pawnandplay.views;
import com.pawnandplay.controller.selectionSort;
...
public class boardGames extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mergeComboBox.setBackground(new java.awt.Color(255, 204, 204));
        mergeComboBox.setFont(new java.awt.Font("ITF Devanagari Marathi", 0, 18)); // NOI18N
        mergeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sort by Stock", "Least in stock", "Most in stock" }));
        mergeComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mergeComboBoxActionPerformed(evt);
            }
        });

        selectionComboBox.setBackground(new java.awt.Color(255, 204, 204));
        selectionComboBox.setFont(new java.awt.Font("ITF Devanagari Marathi", 0, 18)); // NOI18N
        selectionComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sort by ID", "Ascending order", "Descending order", " " }));
        ...
        insertionComboBox.setBackground(new java.awt.Color(255, 204, 204));
        insertionComboBox.setFont(new java.awt.Font("ITF Devanagari Marathi", 0, 18)); // NOI18N
        insertionComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sort by Name", "A to Z order", "Z to A order" }));
        insertionComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                insertionComboBoxActionPerformed(evt);
            }
        });
        ...
        searchBox.setFont(new java.awt.Font("ITF Devanagari Marathi", 0, 18)); // NOI18N
        ...
        jLabel4.setFont(new java.awt.Font("ITF Devanagari Marathi", 0, 18)); // NOI18N
                                ...
                                .addGroup(productPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(productPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(productPageLayout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addComponent(insertionComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addComponent(mergeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        loadingScreenLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, loadingScreenLayout.createSequentialGroup()
                ...
                .addGroup(loadingScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, loadingScreenLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(loadingimg1, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
   ...
   private void gamesData() {
        ...
        gamesList.add(new gamesModel(5, "1000 Puzzles", "Expert", "Party", 12, 50, 6000, "Puzzle world"));
        gamesList.add(new gamesModel(6, "Pandemic", "Intermediate", "Cooperative", 8, 45, 4000, "Z-Man Games"));
        gamesList.add(new gamesModel(7, "Chess", "Expert", "Classic", 6, 60, 3000, "Generic"));
        gamesList.add(new gamesModel(8, "Exploding Kittens", "Beginner", "Party", 7, 15, 1500, "Kittens LLC"));
        gamesList.add(new gamesModel(9, "Clue", "Beginner", "Mystery", 8, 30, 2500, "Hasbro"));
        gamesList.add(new gamesModel(10, "Carcassonne", "Intermediate", "Strategy", 7, 35, 3500, "Z-Man Games"));
        gamesList.add(new gamesModel(11, "Dixit", "Beginner", "Creative", 8, 30, 2800, "Libellud"));
        gamesList.add(new gamesModel(12, "Betrayal at House on the Hill", "Expert", "Horror", 12, 60, 5000, "Avalon Hill"));
        gamesList.add(new gamesModel(13, "Risk", "Intermediate", "Strategy", 10, 120, 4000, "Hasbro"));
        gamesList.add(new gamesModel(14, "Blokus", "Beginner", "Abstract", 7, 20, 2200, "Mattel"));
        gamesList.add(new gamesModel(15, "Azul", "Intermediate", "Abstract", 8, 30, 3500, "Next Move Games"));
        gamesList.add(new gamesModel(16, "Terraforming Mars", "Expert", "Sci-Fi", 12, 120, 6000, "FryxGames"));
        gamesList.add(new gamesModel(17, "The Game of Life", "Beginner", "Family", 8, 45, 2800, "Hasbro"));
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter your username and password.", "Login Error", JOptionPane.ERROR_MESSAGE);
        } 
        // Check if username and password are incorrect
        else if (!username.equals("Sanskriti") || !password.equals("admin")) {
            JOptionPane.showMessageDialog(this, "Either username or password is incorrect!", "Login Error", JOptionPane.ERROR_MESSAGE);
        } 
    ...
    isValid &= validateField(
            idfield, "Game ID", idErrorLabel, "ID must be a positive number between 1 and 9999.",
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        ...
        if (idText.isEmpty()) {
            showDialogBox("Kindly enter an ID!", "Empty ID Field", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Validate the ID format and range
        if (!ValidationUtil.isIdValid(idText)) {
            showDialogBox("ID must be a number between 1 and 9999!", "Invalid ID", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (exists == null) {
            showDialogBox("No game found with the given ID!", "Invalid ID", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        loadListToTable(gamesList);
        showDialogBox("Game has been removed.", "Deleted", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void selectionComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectionComboBoxActionPerformed
        // TODO add your handling code here:
        int value = selectionComboBox.getSelectedIndex();
        selectionSort selectionSort = new selectionSort();

        if (value == 1) {
            List<gamesModel> sortedList = selectionSort.sortById(gamesList, false);
            loadListToTable(sortedList);

        }else if(value == 2){
            List<gamesModel> sortedList = selectionSort.sortById(gamesList, true);
            loadListToTable(sortedList);
        }
    }//GEN-LAST:event_selectionComboBoxActionPerformed

    private void insertionComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertionComboBoxActionPerformed
        // TODO add your handling code here: 
        int order = insertionComboBox.getSelectedIndex();
        ...
        if (order == 1) { // Alphabetically
            sortedList = insertionSort.sortAlphabetically(gamesList);
            loadListToTable(sortedList);
        } else if (order == 2) { // Reverse Alphabetically
            sortedList = insertionSort.sortReverseAlphabetically(gamesList);
            loadListToTable(sortedList);
        }
    }//GEN-LAST:event_insertionComboBoxActionPerformed

    private void mergeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mergeComboBoxActionPerformed
        // TODO add your handling code here:
        int order = mergeComboBox.getSelectedIndex();
        ...
        if (order == 1) { // Most in stock
            sortedList = mergeSort.sortByStockAscending(gamesList);
            loadListToTable(sortedList);
        } else if (order == 2) { // Least amount in stock
            sortedList = mergeSort.sortByStockDescending(gamesList);
            loadListToTable(sortedList);
        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            ...
            if (result == null) {
                ...
                // Show result in a table within a dialog box
    ...
    private void clearGameFields() {
        ...
        idfield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        namefield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        levelfield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        genrefield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        agefield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        stockfield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        pricefield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));
        brandfield.setBorder(javax.swing.BorderFactory.createLineBorder(Color.GRAY));

        // Optionally hide all error labels
    ...
    */
    ...
    private javax.swing.JComboBox<String> insertionComboBox;
    ...
    private javax.swing.JComboBox<String> mergeComboBox;
