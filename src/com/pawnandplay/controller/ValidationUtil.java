...
public class ValidationUtil {
    ...
    private static final Pattern PRODUCT_NAME_PATTERN = Pattern.compile("^[a-zA-Z0-9\\s]+$");
    ...
    public static boolean isIdValid(String idText) {
        ...
        try {
            ...
            return id > 0 && id < 9999; // ID must be in range 1 to 9999
    ...
    /**
     * Validates if the product name contains only alphanumeric characters and spaces.
     *
